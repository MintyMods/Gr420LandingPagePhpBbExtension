...
class install_sample_data extends \phpbb\db\migration\migration
{
	...
	{
		return $this->config->offsetExists('minty_homepage_sample_int');
	}
	...
	public function update_data()
	{
		return array(
			...
			array('config.add', array('minty_homepage_sample_int', 0)),
			// array('config.add', array('minty_homepage_sample_str', '')),

			// // Add a new config_text table setting
			// array('config_text.add', array('minty_homepage_sample', '')),

			// // Add new permissions
			// array('permission.add', array('a_new_minty_homepage')), // New admin permission
			// array('permission.add', array('m_new_minty_homepage')), // New moderator permission
			// array('permission.add', array('u_new_minty_homepage')), // New user permission
			...
			// array('permission.permission_set', array('ROLE_ADMIN_FULL', 'a_new_minty_homepage')), // Give ROLE_ADMIN_FULL a_new_minty_homepage permission
			// array('permission.permission_set', array('ROLE_MOD_FULL', 'm_new_minty_homepage')), // Give ROLE_MOD_FULL m_new_minty_homepage permission
			// array('permission.permission_set', array('ROLE_USER_FULL', 'u_new_minty_homepage')), // Give ROLE_USER_FULL u_new_minty_homepage permission
			// array('permission.permission_set', array('ROLE_USER_STANDARD', 'u_new_minty_homepage')), // Give ROLE_USER_STANDARD u_new_minty_homepage permission
			// array('permission.permission_set', array('REGISTERED', 'u_new_minty_homepage', 'group')), // Give REGISTERED group u_new_minty_homepage permission
			// array('permission.permission_set', array('REGISTERED_COPPA', 'u_new_minty_homepage', 'group', false)), // Set u_new_minty_homepage to never for REGISTERED_COPPA

			// // Add new permission roles
			// array('permission.role_add', array('homepage admin role', 'a_', 'a new role for admins')), // New role "homepage admin role"
			// array('permission.role_add', array('homepage moderator role', 'm_', 'a new role for moderators')), // New role "homepage moderator role"
			// array('permission.role_add', array('homepage user role', 'u_', 'a new role for users')), // New role "homepage user role"
